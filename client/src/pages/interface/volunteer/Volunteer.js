...
const SosCenterUnitCreate = () => {
    ...
    const handleClick = async (e) => {
        ...
        if (!unit.name_tm) {
            ...
            await axios
                .post(`${Api_Address}api/v1/unit/create`, unit, {
                    headers: {
                ...
                .then((res) => {
                    ...
                    localStorage.setItem("volunterr", "true");
                    navigate("/");
                })
                .catch((res) => {
    ...
    return (
        <>
            <div className="card border-0 shadow my-5 mt-4 pt-4">
                <div className={`card-body d-flex justify-content-center align-items-center ${darkMode ? "bg-dark-blue text-white" : ""}`} style={{paddingTop:"200px!important"}}>
                        ...
                        <div className="col-xl-8">
                            <div className="row">
                                ...
                                <div className="d-grid mt-3">
                                    <button onClick={handleClick} className={`btn ${darkMode ? "btn-outline-light" : "btn-danger"}`}>
                                        Send
                                    </button>
                                </div>
                            </div>
